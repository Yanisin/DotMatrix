...
void disp_spi_init(void)
{
	...
	gpio_mode_setup(DISP_COLS_CLK_GPIO, GPIO_MODE_AF, GPIO_PUPD_NONE,
			DISP_COLS_CLK_GPIO_PIN);
	gpio_set_af(DISP_COLS_CLK_GPIO, DISP_COLS_CLK_AF_NUM,DISP_COLS_CLK_GPIO_PIN);
	/* configure the data pin */
	gpio_mode_setup(DISP_COLS_DATA_GPIO, GPIO_MODE_AF, GPIO_PUPD_NONE,
			DISP_COLS_DATA_GPIO_PIN);
	...
	gpio_mode_setup(DISP_COLS_STROBE_GPIO,
			...
			DISP_COLS_STROBE_GPIO_PIN);
	gpio_set_af(DISP_COLS_STROBE_GPIO,
			DISP_COLS_STROBE_AF_NUM, DISP_COLS_STROBE_GPIO_PIN);
